/**
 * File: GUI/line.cpp - Implementation of arrow in MiptVis
 ...
 */
Line::Line( Text * startItem, Text * endItem, QGraphicsItem * parent, QGraphicsScene * scene)
            :QGraphicsLineItem( parent, scene)
{
    ...
    myColor = Qt::red;
    setPen( QPen( myColor, 2, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin)); //Set property of the pen for line
}

/**
 * Return the bounding rectangle of the line - selectable area
 */
...
/**
 * Paint the line from one node to other node
 */
